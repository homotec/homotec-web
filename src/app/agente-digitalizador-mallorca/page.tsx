...
export const metadata: Metadata = {
  ...
  description: 'Somos tu Agente Digitalizador en Mallorca. Te ayudamos a conseguir el bono del Kit Digital para impulsar la digitalización de tu pyme. ¡Consultoría gratuita!',
};

export default function AgenteDigitalizadorMallorca() {
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              En Homotec, como tu <strong>Agente Digitalizador en Mallorca</strong>, te guiamos para que aproveches al máximo el programa Kit Digital. Esta iniciativa del Gobierno de España, con fondos de la Unión Europea – Next Generation EU, te proporciona un &quot;bono digital&quot; para implantar soluciones clave y potenciar tu negocio.
            </p>
          </div>
      ...
      {/* Testimonios de clientes de Mallorca (Placeholder) */}
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <p className="text-gray-500">Logo Cliente 1</p>
            <p className="text-gray-500">Logo Cliente 2</p>
            <p className="text-gray-500">Logo Cliente 3</p>
            <p className="text-gray-500">Logo Cliente 4</p>
          </div>
        </div>
      </section>
